...
class App {
	...
	loadCollege() {
		...
		loader.load('college.glb', function (gltf) {
			let college = gltf.scene.children[0];
			if (!college) {
				console.warn("No children found in GLTF scene. Using scene directly.");
				college = gltf.scene;
			}
			...
			if (!door1 || !door2) {
				console.error("One or both door objects are missing from the model.");
